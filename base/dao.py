...
class Dao(object):
	...
	def __init__(self):
		...
		self.__ats = MysqlHelper(configs['ats'])
	...
	def executeAtsSql(self, sql):
		return self.__ats.executeSql(sql)

	def executeAtsSelectSql(self, sql):
		return self.__ats.findList(sql)
